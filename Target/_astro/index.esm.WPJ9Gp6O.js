 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class He{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(n=>{if(Pe(n)){const s=n.getImmediate();return`${s.library}/${s.version}`}else return null}).filter(n=>n).join(" ")}}function Pe(t){const e=t.getComponent();return e?.type==="VERSION"}const O="@firebase/app",V="0.10.9";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const pt="firebase-heartbeat-database",mt=1,g="firebase-heartbeat-store";let S=null;function Z(){return S||(S=Ne(pt,mt,{upgrade:(t,e)=>{switch(e){case 0:try{t.createObjectStore(g)}catch(n){console.warn(n)}}}}).catch(t=>{throw p.create("idb-open",{originalErrorMessage:t.message})})),S}async function gt(t){try{const n=(await Z()).transaction(g),s=await n.objectStore(g).get(q(t));return await n.done,s}catch(e){if(e instanceof b)d.warn(e.message);else{const n=p.create("idb-get",{originalErrorMessage:e?.message});d.warn(n.message)}}}async function k(t,e){try{const s=(await Z()).transaction(g,"readwrite");await s.objectStore(g).put(e,q(t)),await s.done}catch(n){if(n instanceof b)d.warn(n.message);else{const s=p.create("idb-set",{originalErrorMessage:n?.message});d.warn(s.message)}}}function q(t){return`${t.name}!${t.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function It(t){$(new D("platform-logger",e=>new He(e),"PRIVATE")),$(new D("heartbeat",e=>new Et(e),"PRIVATE")),y(O,V,t),y(O,V,"esm2017"),y("fire-js","")}It("");var vt="firebase",wt="10.13.0";/**
 * @license
...
//# sourceMappingURL=index.esm.WPJ9Gp6O.js.map
